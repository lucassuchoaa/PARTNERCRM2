...
interface ManagerLandingPageProps {
  slug: string
}

export default function ManagerLandingPage({ slug }: ManagerLandingPageProps) {
  ...
  useEffect(() => {
    const fetchManagerInfo = async () => {
      try {
        const response = await fetch(`${API_URL}/partner_prospects/public/manager/${slug}`)

        if (!response.ok) {
          setError('Gerente não encontrado')
          setLoading(false)
          return
        }
        ...
        setError('Erro ao carregar informações do gerente')
      } finally {
        setLoading(false)
      }
    }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-8 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Gerente não encontrado</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <h1 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6">
              Torne-se um <span className="text-blue-600">Parceiro</span>
            </h1>
            <p className="text-xl text-gray-600 mb-4 max-w-2xl mx-auto">
              Convite de <span className="font-bold text-blue-600">{managerInfo?.name}</span>
            </p>
        ...
        {success ? (
          <div className="bg-white rounded-lg shadow-xl p-8 text-center">
            ...
            <p className="text-gray-500 mb-8">
              {managerInfo?.name} irá analisar seu cadastro e entrar em contato em breve.
            </p>
            <button
              onClick={() => {
                setSuccess(false)
