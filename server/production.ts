...
import pricingPlansRoutes from './routes/pricing-plans.js';
import remunerationTablesRoutes from './routes/remuneration-tables.js';
import supportMaterialsRoutes from './routes/support-materials.js';
