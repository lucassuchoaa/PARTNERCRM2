...
Este arquivo contém o SQL que você precisa executar no Supabase para criar todas as tabelas.
...
1. Vá em **Table Editor** no Supabase e confira se apareceram estas tabelas:
   - `pricing_plans` (3 planos)
   - `users`
   - `remuneration_tables`
   - `support_materials`
   - `products` (3 produtos padrão)

2. **Pronto!** Agora faça o **Redeploy** no Vercel para as APIs começarem a usar o Supabase.
